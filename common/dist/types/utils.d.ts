...
export type ValuesOfFunction<T> = T extends (...args: any[]) => infer U ? U : never;
export type ValuesOfClass<T> = T extends new (...args: any[]) => infer U ? U : never;
...
export type Class<T = any, Args extends any[] = any[]> = new (...args: Args) => T;
